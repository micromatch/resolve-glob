# resolve-glob [![NPM version](https://badge.fury.io/js/resolve-glob.svg)](http://badge.fury.io/js/resolve-glob)  [![Build Status](https://travis-ci.org/jonschlinkert/resolve-glob.svg)](https://travis-ci.org/jonschlinkert/resolve-glob)
